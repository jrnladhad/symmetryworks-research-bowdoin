...
#include "../Wallpaper Generation/display.h"
...
QT_MOC_LITERAL(1, 8, 14), // "displayPressed"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "point"
QT_MOC_LITERAL(4, 30, 15), // "displayReleased"
QT_MOC_LITERAL(5, 46, 12) // "displayMoved"

    },
    "Display\0displayPressed\0\0point\0"
    "displayReleased\0displayMoved"
};
...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->displayPressed((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 1: _t->displayReleased((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        case 2: _t->displayMoved((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Display::*_t)(const QPoint & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Display::displayPressed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Display::*_t)(const QPoint & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Display::displayReleased)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Display::*_t)(const QPoint & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Display::displayMoved)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Display::displayPressed(const QPoint & _t1)
{
...
// SIGNAL 1
void Display::displayReleased(const QPoint & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void Display::displayMoved(const QPoint & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
