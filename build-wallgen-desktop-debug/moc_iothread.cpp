...
#include "../Wallpaper Generation/iothread.h"
...
QT_MOC_LITERAL(1, 9, 14), // "finishedExport"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 6) // "result"

    },
    "IOThread\0finishedExport\0\0result"
};
...
void IOThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (IOThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&IOThread::finishedExport)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject IOThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_IOThread.data,
      qt_meta_data_IOThread,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void IOThread::finishedExport(const QString & _t1)
{
