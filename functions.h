...
/*
  This is the base class for all outher classes that follow in this file;
  It defines many of the member functions that we need for all of the derived classes.
*/
