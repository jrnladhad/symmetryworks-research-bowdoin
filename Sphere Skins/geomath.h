...
//For rho5 function, 'a5' is phi(1-i*phi)
const std::complex<double> a5(gold,-1.0-gold);
...
inline std::complex<double> P12(std::complex<double> in)
{
    std::complex<double> tmp(in.real(), in.imag());
    std::complex<double>ans=tmp*tmp;
    double C10=0.0-22.0/q5;
    double C8=0.0-33.0;
    double C6=44.0/q5;
    std::complex<double> ans1=1.0+ans*(C10+ ans*(C8+ans*(C6+ans*(C8+ans*(C10+ans)))));
    return ans1;
}

inline std::complex<double> P20(std::complex<double> in)
{
    std::complex<double> tmp(in.real(), in.imag());
    std::complex<double>ans=tmp*tmp;
    double D18=38.0*q5/3.0;
    double D16=0.0-19.0;
    double D14=152.0*q5;
    double D12=0.0-492.0;
    double D10=0.0-988.0*q5/3.0;
    std::complex<double> ans1=1.0+ans*(D18+ ans*(D16+ans*(D14+ans*(D12+ans*(D10+ans*(D12+ans*(D14+ans*(D16+ans*(D18+ans)))))))));
    return ans1;
}

inline std::complex<double> P30(std::complex<double> in)
{
    std::complex<double> tmp(in.real(), in.imag());
    std::complex<double>ans=tmp*tmp;
    double C27=116.0/(9.0*q5);
    double C25=1769.0/25.0;
    double C23=0.0-464.0/q5;
    double C21=2001.0/5.0;
    double C19=2668.0/(3.0*q5);
    double C17=12673.0/5.0;
    std::complex<double> ans1=tmp*(-1.0-ans*(C27+ans*(C25+ans*(C23+ans*(C21+ans*(C19+ans*(C17-ans*ans*(C17+ans*(C19+ans*(C21+ans*(C23+ans*(C25+ans*(C27+ans)))))))))))));
    return ans1;
}
...
inline std::complex<double> Leg(std::complex<double> in, int nin, int min)
{
    ...
    //Remember that N was really 2N
    std::complex<double> ansH = qCos(2*nin*theta)*ans;
    return ansH;
}
...
{
    std::complex<double> ans(in.real(), in.imag());
    //Some of the spherical harmonics seem to average
    std::complex<double> ans1=Leg(ans,nin,min);
    return ans1;
}
