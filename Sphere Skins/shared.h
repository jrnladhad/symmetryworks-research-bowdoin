...
//constants
const double DEFAULT_WORLD_WIDTH = 2.0*pi;
const double DEFAULT_WORLD_HEIGHT = pi;
const double DEFAULT_XCORNER = 0.0;
const double DEFAULT_YCORNER = 0.0;
const int DEFAULT_OUTPUT_WIDTH = 3000; //6000 width 4800 height standard for art prints
const int DEFAULT_OUTPUT_HEIGHT = 3000;
